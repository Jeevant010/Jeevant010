  ...
  return (
    <div ref={setNodeRef} style={style} className="relative group mb-4">
      <div 
        {...attributes} 
        {...listeners} 
        className="absolute left-0 top-1/2 -translate-y-1/2 -ml-6 cursor-grab active:cursor-grabbing text-shell-muted hover:text-blue-400 opacity-0 group-hover:opacity-100 transition-opacity p-2"
      >
