    ...
    <div className="relative z-10 mb-12 bg-[#2a2520] border-2 border-[#50453b] p-6 shadow-2xl max-w-3xl">
      <div className="flex justify-between items-center mb-4">
        ...
        <button 
          ...
          className="text-xs text-[#8a7560] hover:text-[#e0d0c0] uppercase tracking-widest flex items-center gap-1"
        >
      ...
      <form action={addSnippet} className="space-y-4">
        ...
        {showAdvanced && (
          <div className="space-y-4 pt-4 border-t border-[#50453b]/50 mt-4 animate-in fade-in slide-in-from-top-2">
            ...
            <label className="flex items-center gap-2 text-[#8a7560] text-sm mt-2">
